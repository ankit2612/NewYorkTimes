...
import com.nyt.ankit.fragment.DetailFragment;
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public MyAdapter(Response response,MainActivity mainActivity,FragmentManager fragmentManager) {
    ...
    public MyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        LayoutInflater inflater = LayoutInflater.from(
                parent.getContext());
        View v =
                inflater.inflate(R.layout.layout_master_fragment_row, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FragmentHelper.addAndInitFragmentWithBackStack(detailFragment,R.id.fragment_content_container,fragmentManager);
